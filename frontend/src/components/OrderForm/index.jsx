...
const OrderForm = () => {
  ...
  const fetchOrderHistory = async () => {
    try {
      const response = await axios.get('http://bulk-ordering-platform.onrender.com/api/orders');
  ...
  const handleConfirmOrder = async () => {
    try {
      ...
      const response = await axios.post('http://bulk-ordering-platform.onrender.com/api/orders', orderData);
      console.log('Order successfully placed:', response.data);

      // Clear cart after placing the order (optional)
      await axios.delete('http://bulk-ordering-platform.onrender.com/api/cart');
